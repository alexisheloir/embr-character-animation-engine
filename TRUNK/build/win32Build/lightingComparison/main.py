...
try:
    opts, args = getopt.getopt(sys.argv[1:], 'hi:g:s:p:m:x:', ["help", "IK_DEBUGLEVEL=", "GLOBAL_DEBUGLEVEL=", "SCHEDULER_DEBUGLEVEL=", "PARSER_DEBUGLEVEL=", "MODIFIER_DEBUGLEVEL=", "XML_DEBUGLEVEL="])
